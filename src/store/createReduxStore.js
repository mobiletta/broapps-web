...
const store = createStore(rootReducer, compose(applyMiddleware(reduxThunk.withExtraArgument({ getFirestore }), reduxLogger), reduxFirestore(firebase)));
...
export { firebase, store, firestoreProps };
